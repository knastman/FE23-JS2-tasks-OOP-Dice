...
// const unFreezeBtn = document.querySelector('.unFreezeButton');

// roleDiceBtn.addEventListener('click', rollDice);
...
for(const die of dice){
  ...
  freezeButton.addEventListener('click', ()=>{
    ...
    if (die.isFrozen){
      ...
      dieContainer.classList.add('frozen');
      freezeButton.innerText = 'Unfreeze';
    }
    else if(!die.isFrozen){
      die.unFreeze();
      // freezeButton.classList.remove('frozen');
      dieContainer.classList.remove('frozen');
      freezeButton.innerText = 'Freeze';
    }
    console.log('die.isFrozen');
    console.log(die.isFrozen);
  ...
  buttonContainer.append(freezeButton);
